                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3">
                                    ...
                                    <form class="user" action="<?= base_url('auth/user/register') ?>" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="NIM">
                                        </div>
                                        <div class="form-group">
