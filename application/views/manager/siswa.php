            ...
            <?php foreach ($siswa as $m) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url() . 'ui_con/sekolah/delete_siswa/' . $m['nim']; ?>" class="badge badge-danger mb-2">hapus</a>
                    </td>
                    <?php $i++ ?>
                    ...
                    <div class="modal fade-mb-0" id="<?= str_replace(' ', '', $m['nama']) ?>" tabindex="-1" role="dialog" aria-labelledby="<?= str_replace(' ', '', $m['nama']) ?>Label" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="<?= base_url('ui_con/sekolah/edit_siswa'); ?>" method="POST">
                                    ...
                                    <div class="modal-body pb-0">
                                        <div class="col-sm-12">Nim</div>
                                        <input type="number" class="form-control" id="nim" name="nim" value="<?= $m['nim'] ?>" readonly>
                                    </div>
                                    <div class="modal-body pb-0">
    ...
    <div class="modal fade-mb-0" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('ui_con/sekolah/siswa'); ?>" method="POST">
