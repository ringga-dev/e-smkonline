...
<div class="container-fluid">
    ...
    <form action="" method="POST" class="col-md-12 text-right m-2 ">
        <a href="" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add New Admin</a>
    </form>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="<?= str_replace(' ', '', $m['nama']) ?>Label">edit</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form action="<?= base_url('ui_con/setting/edit_admin'); ?>" method="POST">
                                    ...
                                    <div class="modal-body pb-0">
                                        <div class="col-sm-12">no identitas</div>
                                        <input type="number" class="form-control" id="no_identitas" name="no_identitas" value="<?= $m['no_identitas'] ?>" readonly>
                                    </div>
                                    <div class="modal-body pb-0">
                                    ...
                                    <div class="modal-body pb-0">
                                        <div class="col-sm-12">jabatan</div>
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?= $m['jabatan'] ?>">
                                    </div>
                                    <div class="modal-body pb-0">
    ...
    <div class="modal fade-mb-0" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('ui_con/setting/data_admin'); ?>" method="POST">

                    <div class="modal-body pb-0">
                        <input type="number" class="form-control" id="no_identitas" name="no_identitas" placeholder="no_identitas">
                    </div>
                    <div class="modal-body pb-0">
