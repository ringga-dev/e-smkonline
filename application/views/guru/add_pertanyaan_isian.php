            ...
            foreach ($pertanyaan as $r) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <a href="<?= base_url() . 'ui_con/guru/delete_pertanyaan_isian/?id=' . $r['id'] . '&tugas_id=' . $tugas['id'] ?>" class="badge badge-danger mb-2">hapus</a>
                    </td>
    ...
    <div class="modal fade-mb-0" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('ui_con/guru/add_pertanyaan_isian/') . $tugas['id']; ?>" method="POST">
