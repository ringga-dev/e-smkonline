...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        foreach ($pertemuan_kelas as $r) : ?>

            <div class="card p-0" style="width: 22rem;" <?= cek_hadir_pertemuan($r['id'], $user['id']); ?>>
                <div class="card-body ">
                    ...
                    <form class="col-md-12 text-right">
                        <a href="<?= base_url() . 'ui_con/siswa/hadir_pertemuan/' . $r['id']; ?>" class="btn btn-info">Hadiri</a>
                    </form>
